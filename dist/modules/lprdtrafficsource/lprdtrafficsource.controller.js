...
const create_lprdtrafficsource_dto_1 = require("./dtos/create-lprdtrafficsource.dto");
const update_lprdtrafficsource_dto_1 = require("./dtos/update-lprdtrafficsource.dto");
...
__decorate([
    (0, common_1.Post)(),
    (0, swagger_1.ApiBody)({ type: create_lprdtrafficsource_dto_1.CreateLprdTrafficSourceDto }),
...
__decorate([
    ...
    (0, swagger_1.ApiBody)({ type: update_lprdtrafficsource_dto_1.UpdateLprdTrafficSourceDto }),
    __param(0, (0, common_1.Param)('id')),
...
exports.LprdTrafficSourceController = LprdTrafficSourceController = __decorate([
    (0, swagger_1.ApiTags)('LprdTrafficSources'),
