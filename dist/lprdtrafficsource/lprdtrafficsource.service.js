...
exports.LprdTrafficSourceService = void 0;
const common_1 = require("@nestjs/common");
const typeorm_1 = require("@nestjs/typeorm");
const typeorm_2 = require("typeorm");
const lprdtrafficsource_entity_1 = require("./lprdtrafficsource.entity");
let LprdTrafficSourceService = class LprdTrafficSourceService {
    constructor(lprdTrafficSourceRepository) {
        this.lprdTrafficSourceRepository = lprdTrafficSourceRepository;
    }
    async create(data) {
...
exports.LprdTrafficSourceService = LprdTrafficSourceService = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(lprdtrafficsource_entity_1.LprdTrafficSource)),
    __metadata("design:paramtypes", [typeorm_2.Repository])
], LprdTrafficSourceService);
//# sourceMappingURL=lprdtrafficsource.service.js.map